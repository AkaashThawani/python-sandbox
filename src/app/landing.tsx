...
export default function Landing() {
  ...
  return (
    <div className="bg-slate-900 text-slate-100 font-sans overflow-y-auto min-h-screen">
      {/* Hero Section - Full Viewport Height */}
      <section className="min-h-screen flex items-center px-4 py-4 md:py-8">
      ...
      <section className="min-h-screen flex items-center px-4 py-4 md:py-6">
